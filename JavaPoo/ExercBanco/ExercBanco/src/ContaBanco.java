public class ContaBanco {
	...
	public void fecharConta() {
		if(getSaldo() == 0) {
			...
			System.out.println("Sua conta está negativa, pague o que deve!");
		}
		else if(getSaldo() > 0){
	...
	public void depositar(double rs) {
		if(getStatus()) {
			...
			System.out.println("Você deve abrir uma conta primeiro!");
		}
	}
		...
		if(getStatus()) {
			if(getSaldo() > 0) {
				if(getTipo().equals("cp")) {
					...
					System.out.println("Foi descontado R$20,00. Agora você tem: "+getSaldo()+" de saldo.");
				}
				else if(getTipo().equals("cc")) {
					setSaldo(getSaldo() - 12);
					System.out.println("Foi descontado R$12,00. Agora você tem: "+getSaldo()+" de saldo.");
				}
			}
			else {
				System.out.println("Se nem tem esse dinheiro.");
