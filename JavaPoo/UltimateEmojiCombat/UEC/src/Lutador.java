public class Lutador {
	...
	public void xingado() {
		setLife(getLife() - 50);
		System.out.println(getNome()+" teve sua mãe xingada! ---- VIDA: "+getLife());
	}
	...
	private void setCategoria() {
		if(getPeso()<52.2) System.out.println("Você está fora dos parâmetros, não poderá lutar!");
		else if(getPeso() <= 70.3) this.categoria = "Leve";
		else if(getPeso() <= 83.9) this.categoria = "Médio";
		else if(getPeso() <= 120.2) this.categoria = "Pesado";
		else { 
			this.categoria = "Invalida"; 
			System.out.println("Você está fora dos parâmetros, não poderá lutar!");
		}
	}
