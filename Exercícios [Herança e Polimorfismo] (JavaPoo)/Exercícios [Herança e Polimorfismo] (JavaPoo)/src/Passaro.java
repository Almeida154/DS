...
public class Passaro extends Animal implements AnimalAdestrado, AnimalDomesticado, AnimalSelvagem{
	...
	public void BarulhoAdestrado() {
		System.out.println("\nO(A) "+ this.getNome() +" diz: FIOFIOOO! [Tradução: Oi, sou adestrado!]");
	}	


	@Override
	public void BarulhoSelvagem() {
		System.out.println("\nO(A) "+ this.getNome() +" diz: PAPAPAUA! [Tradução: Saia! Sou selvagem.]");
		
	}

	@Override
	public void BarulhoDomesticado() {
		System.out.println("\nO(A) "+ this.getNome() +" diz: piupiupiupiu! [Tradução: Oi, dono. Sou domesticado!]");
