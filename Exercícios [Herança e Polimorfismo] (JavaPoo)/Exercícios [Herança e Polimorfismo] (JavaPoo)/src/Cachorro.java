...
public class Cachorro extends Animal implements AnimalAdestrado, AnimalDomesticado, AnimalSelvagem{
	...
	public void BarulhoAdestrado() {
		System.out.println("\nO(A) "+ this.getNome() +" diz: AU! [Tradução: Oi, sou adestrado!]");
	}	


	@Override
	public void BarulhoSelvagem() {
		System.out.println("\nO(A) "+ this.getNome() +" diz: AUAUAROSNEI! [Tradução: Saia! Sou selvagem.]");
		
	}

	@Override
	public void BarulhoDomesticado() {
		System.out.println("\nO(A) "+ this.getNome() +" diz: AU! [Tradução: Oi, dono. Sou domesticado!]");
