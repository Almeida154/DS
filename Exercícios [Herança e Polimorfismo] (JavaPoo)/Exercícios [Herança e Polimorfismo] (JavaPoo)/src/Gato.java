...
public class Gato extends Animal implements AnimalAdestrado, AnimalDomesticado, AnimalSelvagem{
	...
	public void BarulhoAdestrado() {
		System.out.println("\nO(A) "+ this.getNome() +" diz: MIAU! [Tradução: Oi, sou adestrado!]");
	}	


	@Override
	public void BarulhoSelvagem() {
		System.out.println("\nO(A) "+ this.getNome() +" diz: MIAAAAAAAAU! [Tradução: Saia! Sou selvagem.]");
		
	}

	@Override
	public void BarulhoDomesticado() {
		System.out.println("\nO(A) "+ this.getNome() +" diz: MIAU! [Tradução: Oi, dono. Sou domesticado!]");
